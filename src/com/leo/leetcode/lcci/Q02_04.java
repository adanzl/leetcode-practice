...
public class Q02_04 {
    ...
    public static void main(String[] args) {
        // [2,2,1,5,3,4]
        System.out.println(listNodeToString(new Q02_04().partition(stringToListNode("[1,4,3,2,5,2]"), 3)));
        // [3,1,2,10,5,5,8]
        System.out.println(listNodeToString(new Q02_04().partition(stringToListNode("[3,5,8,5,10,2,1]"), 5)));
    }
