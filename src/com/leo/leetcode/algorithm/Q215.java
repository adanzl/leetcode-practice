...
public class Q215 {
    ...
    public void TestOJ() {
        ...
        System.out.println(findKthLargest(LCUtil.stringToIntegerArray("[3,2]"), 2)); // 2
        System.out.println(findKthLargest(LCUtil.stringToIntegerArray("[3]"), 1)); // 3
    }
    ...
    public int findKthLargest1(int[] nums, int k) {
        ...
        while (true) {
            ...
            int l = start, r = end;
            while (l < r) {
                while (nums[r] >= ret && l < r) {
                    r--;
                }
                while (nums[l] <= ret && l < r) {
                    l++;
                }
                swap(nums, l, r);
            }
