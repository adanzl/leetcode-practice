 ...
 * 提示：
 * 1、1 <= password.length <= 50
 * 2、password 由字母、数字、点 '.' 或者感叹号 '!'
...
public class Q420 {
    ...
    public static void main(String[] args) {
        // 5
        System.out.println(new Q420().strongPasswordChecker("a"));
        // 3
        System.out.println(new Q420().strongPasswordChecker("aA1"));
        // 0
        System.out.println(new Q420().strongPasswordChecker("1337C0d3"));
    }
