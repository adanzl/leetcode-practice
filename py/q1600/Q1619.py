...
class Solution:
    ...
    def trimMean(self, arr: List[int]) -> float:
        return sum(sorted(arr)[int(len(arr) / 20):int(19 * len(arr) / 20)]) / (len(arr) * 9 / 10)
...
if __name__ == '__main__':
    ...
    # 5.29167
    print(Solution().trimMean([
        4, 8, 4, 10, 0, 7, 1, 3, 7, 8, 8, 3, 4, 1, 6, 2, 1, 1, 8, 0, 9, 8, 0, 3, 9, 10, 3, 10, 1, 10, 7, 3, 2, 1, 4, 9, 10, 7, 6, 4, 0, 8, 5, 1, 2, 1, 6, 2, 5, 0, 7, 10, 9, 10, 3, 7, 10, 5, 8, 5, 7,
